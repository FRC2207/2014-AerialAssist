...
<Project Type="Project" LVVersion="13008000">
	...
	<Item Name="RT CompactRIO Target" Type="RT CompactRIO">
		...
		<Property Name="alias.value" Type="Str">10.22.07.2</Property>
...
DirectoryIndex index.htm
		...
		<Item Name="Team Code" Type="Folder">
			...
			<Item Name="Get Enum Arm Positions.vi" Type="VI" URL="../Get Enum Arm Positions.vi"/>
			<Item Name="Limit Switch.vi" Type="VI" URL="../Limit Switch.vi"/>
			<Item Name="latch_lock.vi" Type="VI" URL="../latch_lock.vi"/>
			<Item Name="Multi Latch.vi" Type="VI" URL="../Multi Latch.vi"/>
			<Item Name="LimitAcceleration.vi" Type="VI" URL="../LimitAcceleration.vi"/>
			<Item Name="Get Robot Info.vi" Type="VI" URL="../Get Robot Info.vi"/>
			<Item Name="Arm Control.vi" Type="VI" URL="../Arm Control.vi"/>
			<Item Name="ZachArmPosition.vi" Type="VI" URL="../ZachArmPosition.vi"/>
			<Item Name="ButtonDelay.vi" Type="VI" URL="../ButtonDelay.vi"/>
			<Item Name="Shooter.vi" Type="VI" URL="../Shooter.vi"/>
			<Item Name="Arm Position Corection.vi" Type="VI" URL="../Arm Position Corection.vi"/>
		</Item>
		<Item Name="Support Code" Type="Folder">
			<Item Name="Elapsed Times.vi" Type="VI" URL="../Elapsed Times.vi"/>
		</Item>
		<Item Name="Team Typedefs" Type="Folder">
			<Item Name="User Commands typedef.ctl" Type="VI" URL="../User Commands typedef.ctl"/>
			<Item Name="Arm control typedef.ctl" Type="VI" URL="../Arm control typedef.ctl"/>
			<Item Name="Arm Postions Enum Typedef.ctl" Type="VI" URL="../Arm Postions Enum Typedef.ctl"/>
			<Item Name="Shooter Commands Typedef.ctl" Type="VI" URL="../Shooter Commands Typedef.ctl"/>
			<Item Name="Drive Commands Typedef.ctl" Type="VI" URL="../Drive Commands Typedef.ctl"/>
			<Item Name="Arm State Enum Typedef.ctl" Type="VI" URL="../Arm State Enum Typedef.ctl"/>
			<Item Name="Shooter State Enum.ctl" Type="VI" URL="../Shooter State Enum.ctl"/>
			<Item Name="Shooter Info Typedef.ctl" Type="VI" URL="../Shooter Info Typedef.ctl"/>
			<Item Name="Arm Info Typedef.ctl" Type="VI" URL="../Arm Info Typedef.ctl"/>
			<Item Name="Robot Info Typedef.ctl" Type="VI" URL="../Robot Info Typedef.ctl"/>
		</Item>
		<Item Name="Robot Main.vi" Type="VI" URL="../Robot Main.vi"/>
		<Item Name="Arm Position Indicator Enum.vi" Type="VI" URL="../Arm Position Indicator Enum.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="Source[0].itemID" Type="Str">{FCF2E528-BBB4-49D0-87C7-936E756DC630}</Property>
